...
from events.views import GetEventsView, CreateEventView, EventParticipationView, EventIdsByUserIdView
from users.views import GetUserView

urlpatterns = [
    # path('admin/', admin.site.urls),
    url(r'^events/get-list/', GetEventsView.as_view({'get': 'list'})),
    url(r'^events/get-users-events/', EventIdsByUserIdView.as_view({'get': 'list'})),
